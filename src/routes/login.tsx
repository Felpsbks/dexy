            ...
            <div className="relative bg-[#0c101a] rounded-[2rem] p-8 sm:p-10 shadow-2xl backdrop-blur-xl h-full w-full">
              <div className="flex flex-col items-center mb-8">
                ...
                <h2 className="text-2xl font-bold text-white">
                  {mode === "signin" ? "Bem-vindo de volta!" : "Criar uma conta"}
                </h2>
              ...
              <form onSubmit={submit} className="space-y-4">
                ...
                {mode === "signin" && (
                  <div className="flex items-center justify-between pt-1">
                    ...
                    <a href="#" className="text-xs text-[#00e5ff] hover:text-white transition">
                      Esqueceu sua senha?
                    </a>
                  </div>
                )}
              ...
              <div className="flex gap-3 mb-6">
                <button className="flex-1 bg-[#131924] hover:bg-[#1a2233] border border-gray-800 transition-colors py-2.5 rounded-xl flex items-center justify-center">
